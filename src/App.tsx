        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-5 h-16 flex items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <a
              ...
              className="font-sans text-xs font-semibold h-10 w-10 justify-center sm:h-auto sm:w-auto sm:justify-start px-0 sm:px-4 sm:py-2 rounded-xl border border-[#E2BC7E]/40 bg-[#1D400E]/60 text-[#E2BC7E] hover:bg-[#316817] hover:text-white transition-all duration-200 flex items-center gap-2 shadow-sm backdrop-blur-sm flex-shrink-0"
            >
